...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$dirFiles\keyshot_w64_7.3.40.exe" -Parameters '/S /AllUsers /FlexLM=27070@vmwas22.winad.msudenver.edu /NO_UPDATE /NO_CLOUD' -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$envProgramFiles\KeyShot7\uninst.exe" -Parameters "/S"
